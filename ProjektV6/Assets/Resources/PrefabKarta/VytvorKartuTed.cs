        ...
        for (y = 0; y < pocetKaret; y++)
        {
           // int randJmena = Random.Range(1, kartaVybavaData.dataJmenaKaret.Length);
            ...
            else
            {
                ...
                if (randARHE == 0)
                {
                    randMRSprite = Random.Range(0, kartaVybavaData.helma.Length);
          ...
          //  kartaInfToEdit.jmeno.text = kartaVybavaData.dataJmenaKaret[randJmena];
            ...
            kartaInfToEdit.NapisStaty(randStats * 10, randStats, randStats, randStats, randStats, randStats, randARHE, randMRSprite);
